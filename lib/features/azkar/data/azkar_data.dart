...
export "../models/azkar_model.dart";
export "../models/zekr_model.dart";

extension ZekrExtension on AzkarType {
  Azkar get azkarByType {
    switch (this) {
      case AzkarType.wakeUp:
        return AzkarConstants.wakingUp;
      case AzkarType.morning:
        return AzkarConstants.morning;
...
abstract class AzkarConstants {
  ...
  static final List<Zekr> defaultAzkar = [
    ...
    Zekr(count: 3, content: suretAlFalaq),
    Zekr(count: 3, content: suretAlNas),
  ];
...
""",
  ...
  static final Azkar sleep = Azkar(
    ...
    data: [
      ...
      Zekr(count: 1, content: "بِاسْـمِكَ اللّهُـمَّ أَمـوتُ وَأَحْـيا"),
      Zekr(
        count: 1,
        content:
      ...
      Zekr(count: 33, content: "سُبْحَانَ اللَّهِ"),
      Zekr(count: 33, content: "الْحَمْدُ لِلَّهِ"),
      Zekr(count: 34, content: "اللَّهُ أَكْبَرُ"),
    ],
  );
}
